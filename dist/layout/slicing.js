...
export function _estimate_text_box_size(text, font_size, direction) {
    if (!text) {
        ...
        for (const owner_panel of this.panels) {
            for (const node of owner_panel.speeches) {
                ...
                if (width !== null && height === null && aspect_ratio) {
                    ...
                    const [est_w, est_h] = _estimate_text_box_size(attrs.text, attrs.fontSize, attrs.textDirection);
