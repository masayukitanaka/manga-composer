...
export class SVGRenderer {
    ...
    _skew_fill(g, panel, r, c) {
        const attrs = panel.attrs;
        const clip_x_min = panel.shared_left_skewline || attrs.skewLeft !== 0 ? Math.min(c.tl_x, c.bl_x) : r.x;
        const clip_x_max = panel.shared_right_skewline || attrs.skewRight !== 0 ? Math.max(c.tr_x, c.br_x) : r.x + r.w;
