...
export declare const FONT_STYLES: readonly FontStyle[];
export declare const FONT_WEIGHTS: readonly FontWeight[];
export declare const DEFAULT_FONT_STACK = "Hiragino Sans, Hiragino Kaku Gothic Pro, Yu Gothic, Noto Sans CJK JP, sans-serif";
